...
const PriceView: NextPage = ({}: //   price,
//   setPrice,
//   setFinalize,
//   takerAddress,
{
  ...
  //   const disabled = data && sellAmount ? parseUnits(sellAmount, sellTokenDecimals) > data.value : true;
  //   console.log(data, isError, isLoading);
  //   return (
  //     <form>
  //       <h1 className="text-3xl font-bold mb-4">0x Swap API Demo</h1>
  //       <p className="text-md mb-2">
  //         Check out the <a href="https://0x.org/docs/">0x Docs</a> and <a href="https://0x.org/docs/">Code</a> to build
  //         your own
  //       </p>
  ...
  //           <img alt={sellToken} className="h-9 w-9 mr-2 rounded-md" src={POLYGON_TOKENS_BY_SYMBOL[sellToken].logoURI} />
  ...
  //           <img alt={buyToken} className="h-9 w-9 mr-2 rounded-md" src={POLYGON_TOKENS_BY_SYMBOL[buyToken].logoURI} />
  //           <select
  ...
  //             ? "Affiliate Fee: " +
  //               Number(formatUnits(BigInt(price.grossBuyAmount), POLYGON_TOKENS_BY_SYMBOL[buyToken].decimals)) *
  //                 AFFILIATE_FEE +
  //               " " +
  ...
  return (
    <>
      ...
      >
        <Stack direction="column" justifyContent="center" alignItems="stretch" spacing={2} margin={2}>
